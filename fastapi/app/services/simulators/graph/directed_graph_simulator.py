...
class DirectedGraphSimulator(BaseSimulator):
    """Enhanced Directed Graph simulator with detailed step-by-step execution tracking"""
    
    def __init__(self):
        super().__init__("directedgraph")
    ...
    def execute_code(self, code: str, exec_id: str, created_at: datetime) -> List[ExecutionStepSchema]:
        """Execute directed graph code with detailed step-by-step tracking"""
        steps = []
        self.reset_context()
        ...
        try:
            ...
            return self.direct_executor.execute(
                code, 
                data_structure_type="directedgraph", 
    ...
    def _get_graph_display(self, instance):
        """Get graph display representation for directed graph"""
