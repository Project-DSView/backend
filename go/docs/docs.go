    ...
    "paths": {
        ...
        "/api/courses": {
            ...
            "post": {
                ...
                "description": "Create a new course (Teacher and Admin only). Requires both API key and JWT authentication.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/exercises/{id}/submit": {
            "post": {
                ...
                "description": "ส่งแบบฝึกหัด Python และประเมินผลด้วย Docker executor เทียบกับ test cases",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/playground/run": {
            "post": {
                "security": [],
                "description": "Forward code execution request to FastAPI playground service and return the response",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/api/queue/jobs": {
            "get": {
                ...
                "description": "Get queue jobs with filtering and pagination (Teachers can see all, students see only their own)",
                "produces": [
                    "application/json"
                ],
                "tags": [
